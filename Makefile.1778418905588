#
# OMNeT++/OMNEST Makefile for i233009_Cnet_Project
#
# This file was generated with the command:
#  opp_makemake -f --deep -O out -KINET4_5_PROJ=../inet4.5 -DINET_IMPORT -I. -I$$\(INET4_5_PROJ\)/src -L$$\(INET4_5_PROJ\)/src -lINET$$\(D\) -d src
#

# Name of target to be created (-o option)
TARGET_DIR = .
TARGET_NAME = i233009_Cnet_Project$(D)
